...
pub fn mlp_predict_common(mlp: MLP, inputs: * f64, classification_mode: bool) -> * * f64 {
...
pub extern fn mlp_regression(mlp: MLP, inputs: * f64) -> * * f64 {
    return mlp_predict_common(mlp, inputs, False);
}

pub extern fn mlp_classification(mlp: MLP, inputs: * f64) -> * * f64 {
